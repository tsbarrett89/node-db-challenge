...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
    ...
    Relational Database is a thing used to store data, SQL is the language used to talk to and manipulate databases.
    

- [ ] Why do tables need a `primary key`?

    Luis said so. That way each resource has a unique identifier.
